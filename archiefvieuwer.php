      ...
      <div class="tooltip">
        ...
        <main role="main" class="container">
            ...
            <div class="dashboard-container1">
                ...
                <br> 
                <h6>Aangifte:</h6>
                <button style="width:222px;" onclick="window.location.href='./archief-files/aangifte'"class="recpers btn btn-panel panel-item">
                  <p>Aangifte</p>
                </button>
                <button style="width:222px;" onclick="window.location.href='./archief-files/aangifteinzameling'"class="recpers btn btn-panel panel-item">
                  <p>Aangifte inzameling</p>
                </button>
                <?php if ($_SESSION["role"] == "admin") { ?>
                <button style="width:222px;" onclick="window.location.href='./archief-files/aangiftehistory'"class="recpers btn btn-panel panel-item">
                  <p>Aangifte History (Admin)</p>
                </button>
                <?php } ?>
                </div>  
                <!-- Right Container -->
...
<br />
<br />          
                <h6>Recherche documenten:</h6>
                <button style="width:222px;" onclick="window.location.href='./archief-files/Recherchehandboek'"class="recpers btn btn-panel panel-item">
                  <p>Recherche Handboek</p>
                </button>
                <button style="width:222px;" onclick="window.location.href='./archief-files/Huiszoekingsbevel'"class="recpers btn btn-panel panel-item">
                  <p>Huiszoekingsbevel</p>
                </button>
                <button style="width:222px;" onclick="window.location.href='./archief-files/shuiszoekingsbevel'"class="recpers btn btn-panel panel-item">
                  <p>Spoed Huiszoekingsbevel</p>
                </button>
