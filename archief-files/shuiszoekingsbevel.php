    ...
    <div class="sidebar-footer">
      ...
      <div class="tooltip">
        ...
        <main role="main" class="container">
            ...
            <iframe style="padding:0;" width="1000px" height="800px" src="./pdf/shuiszoekingsbevel.pdf#toolbar=0"></iframe>
            </div>
            <button style="width:222px; margin-left:447px;" onclick="window.location.href='./pdf/shuiszoekingsbevel.docx'"class="recpers btn btn-panel panel-item">
                  <p>Huiszoekingsbevel Downloaden</p>
                </button>
        </main><!-- /.container -->
