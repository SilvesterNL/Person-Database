<?php
    ...
    $aanfigtes = $con->query("SELECT * FROM aangifte ORDER BY created DESC");
    $aangiftes_array = [];
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        if ($_POST['type'] == "show") {
            $_SESSION["aangifteselector"] = $_POST["selector"];
            Header("Location: aangiftevieuwer");
        }}
    ...
    <div class="sidebar-footer">
      ...
      <div class="tooltip">
        ...
        <main role="main" class="container">
            ...
            <h5 class="panel-container-title">Lopende Aangiftes:</h5>
                        ...
                        <?php foreach($aangiftes_array as $aangiftedata) {?>
                            <form method="post" action="">
                                ...
                                <button type="submit" class="aangifte btn btn-panel panel-item" style="text-align:left!important;">
                                    ...
                                    <p class="panel-author">Title: <?php echo $aangiftedata['datum']; ?></p>

                                </button>
                            </form>
                        <?php }?>
                    <?php } else { ?>
                            <p>Geen lopende aangiftes..</p>
                    <?php } ?>
            </div>
        </main><!-- /.container -->
