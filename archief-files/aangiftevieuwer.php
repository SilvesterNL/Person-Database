<?php
    ...
    $aanfigtes = $con->query("SELECT * FROM aangifte WHERE created='$datavanaanfigte'");
    $aangiftes_array = [];
...
<br />
<p>AANGIFTE:</p>
<li>Ik, verbalisant <?php echo $aangiftedata["agent"]?> van politie Fomato maak de volgende aangifte op:</li>
<li></li>
<p>BEVINDINGEN</p>
...
<form method="post" action="">
                                ...
                                <input type="hidden" name="datum" value="<?php echo $aangiftedata['datum'];?>">
                                <input type="hidden" name="agent" value="<?php echo $aangiftedata['agent'];?>">
                                <input type="hidden" name="gestolengoed" value="<?php echo $aangiftedata['gestolengoed'];?>">
                                <input type="hidden" name="naamslacht" value="<?php echo $aangiftedata['naamslacht'];?>">
                                <input type="hidden" name="locatie" value="<?php echo $aangiftedata['locatie'];?>">
                                <input type="hidden" name="gebeurtenis" value="<?php echo $aangiftedata['gebeurtenis'];?>">
                                <input type="hidden" name="bewijs" value="<?php echo $aangiftedata['bewijs'];?>">
                                <input type="hidden" name="verdachtesign" value="<?php echo $aangiftedata['verdachtesign'];?>">
                                <button type="submit" class="aangifte btn btn-panel panel-item" style="text-align:center!important;">
                                    <h5 class="panel-title"><strong>Verwijder Aangifte</strong></h5>
