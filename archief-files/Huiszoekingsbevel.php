    ...
    <div class="sidebar-footer">
      ...
      <div class="tooltip">
        ...
        <main role="main" class="container">
            ...
            <iframe style="padding:0;" width="1000px" height="800px" src="./pdf/Huiszoekingsbevel.pdf#toolbar=0"></iframe>
            </div>
            <button style="width:222px; margin-left:447px;" onclick="window.location.href='./pdf/Huiszoekingsbevel.docx'"class="recpers btn btn-panel panel-item">
